    ...
    switch method
        ...
        case 2 %% solvex_var  
            ...
            FILE_log = fopen(strcat(handles.opt.outpath, ...
                                    ...
                                    sprintf('LOG_VAR_TV_maxit%d_PCGmaxit%d_LKmaxit%d_sigma%g_RegERR%d_exp1.txt', ...
                                            handles.opt.maxit, ...
        ...
        case 3 %% solvex_varL4
            ...
            FILE_log = fopen(strcat(handles.opt.outpath, ...
                                    handles.opt.out_file_prefix, ...
                                    sprintf('LOG_VAR_L4_maxit%d_PCGmaxit%d_LKmaxit%d_sigma%g_RegERR%d_exp1.txt', ...
                                            handles.opt.maxit, ...
                                            handles.opt.PCG_maxit, ...
                                            handles.opt.LK_maxit, ...
                                            handles.opt.sigma, ...
        ...
        case 4 %% solvex_varL4SAR
            ...
            FILE_log = fopen(strcat(handles.opt.outpath, ...
                                    handles.opt.out_file_prefix, ...
                                    sprintf('LOG_VAR_SAR_maxit%d_PCGmaxit%d_LKmaxit%d_sigma%g_RegERR%d_exp1.txt', ...
                                            handles.opt.maxit, ...
                                            handles.opt.PCG_maxit, ...
                                            handles.opt.LK_maxit, ...
                                            handles.opt.sigma, ...
        ...
        case 5 %% solvex_varL4SAR Combination (same as 4?)
            ...
            FILE_log = fopen(strcat(handles.opt.outpath, ...
                                    handles.opt.out_file_prefix, ...
                                    sprintf('LOG_VAR_combL4SAR_maxit%d_PCGmaxit%d_LKmaxit%d_sigma%g_RegERR%d_exp1.txt', ...
                                            handles.opt.maxit, ...
                                            handles.opt.PCG_maxit, ...
                                            handles.opt.LK_maxit, ...
                                            handles.opt.sigma, ...
        ...
        case 7 %% RobustSR
            ...
            FILE_log = fopen(strcat(handles.opt.outpath, ...
                                    handles.opt.out_file_prefix, ...
                                    sprintf('LOG_RSR_maxit%d_PCGmaxit%d_LKmaxit%d_sigma%g_RegERR%d_exp1.txt', ...
                                            handles.opt.maxit, ...
                                            handles.opt.PCG_maxit, ...
                                            handles.opt.LK_maxit, ...
                                            handles.opt.sigma, ...
        ...
        case 8 %% Zomet
            ...
            FILE_log = fopen(strcat(handles.opt.outpath, ...
                                    handles.opt.out_file_prefix, ...
                                    sprintf('LOG_Zomet_maxit%d_PCGmaxit%d_LKmaxit%d_sigma%g_RegERR%d_exp1.txt', ...
                                            handles.opt.maxit, ...
                                            handles.opt.PCG_maxit, ...
                                            handles.opt.LK_maxit, ...
                                            handles.opt.sigma, ...
